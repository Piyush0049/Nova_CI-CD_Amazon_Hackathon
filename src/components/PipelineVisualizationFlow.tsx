        ...
        <Card className="p-6">
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground">Amazon Nova analyzed your repository</p>
            </div>
          </div>
              ...
              <Card className="p-4 border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Amazon Nova</div>
                  </div>
                </div>
              </Card>
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      This pipeline was intelligently generated by Amazon Nova AI based on your repository&apos;s structure,
